...
public class DataInfo {
    ...
    private List<StairsInfo> stairsInfos;
    ...
    public List<StairsInfo> getStairsInfos() {
        return stairsInfos;
    }

    public void setStairsInfos(List<StairsInfo> stairsInfos) {
        this.stairsInfos = stairsInfos;
    }
